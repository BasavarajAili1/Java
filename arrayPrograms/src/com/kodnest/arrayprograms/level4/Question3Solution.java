...
public class Question3Solution {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter length of 1st Array");
		...
		SumOfCurrespondingElements sum=new SumOfCurrespondingElements();
		int res[]=sum.sum(arr1, arr2);
		System.out.print("Elements of 3rd Array after adding curresponding elements of 1st and 2nd Array===> ");
		for(int x: res) {
			System.out.print(x+" ");
		}
	}
